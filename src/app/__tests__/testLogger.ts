...
export function logApi(
  ...
  const methodColor = methodColors[method.toUpperCase()] || chalk.bgWhite.black.bold;
  ...
  console.log('\n');
  console.log(`${methodColor(` ${method.toUpperCase()} `)}${chalk.reset('  ')}${chalk.bold.white(url)}${badgeStr}${descStr}`);
  if (resolvedUrl !== url) {
